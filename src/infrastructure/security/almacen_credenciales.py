...
from shared.errores import CredentialError, MissingCredentialsError
from shared.ajustes import APP_ID
    ...
    def _delete(self, account: str) -> None:
        try:
            ...
            if exc.__class__.__name__ == "PasswordDeleteError":
                return
            raise CredentialError("No se pudo eliminar el secreto de Windows Credential Manager.") from exc
